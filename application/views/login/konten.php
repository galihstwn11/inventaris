    ...
    <!-- Header: Title -->
    <!-- ============================================================== -->
    <div class="header" style="background-color: #343a40; padding: 40px 15px 5px 15px; text-align: center;">
    <h1 class="text-white" style="margin-top: -50;">Selamat Datang di Halaman Login</h1>
</div>
        <!-- ============================================================== -->
