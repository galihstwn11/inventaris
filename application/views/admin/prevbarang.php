...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="card cetak" id="printElement">
        <div class="card-body">
            <h5 class="card-title text-center">KONDISI SARANA SEKOLAH <br> TAHUN 2025 BERDASARKAN PERATURAN MENTERI PENDIDIKAN NASIONAL <br> NOMOR 4 TAHUN 2007</h5>
            <hr>
            <div class="table-responsive">
                <table id="zero_config" class="table table-bordered">
                    ...
                    <tr style="background-color: #F1F1F1">
                        <th>F</th>
                        <th colspan="7">SARANA PRASARANA RUANG LABORATORIUM MUSIK</th>
                    </tr>
                    ...
                    <tr style="background-color: #F1F1F1">
                        <th>N</th>
                        <th colspan="7">SARANA PRASARANA GEDUNG OLAHRAGA</th>
                    </tr>
